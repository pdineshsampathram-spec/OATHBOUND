...
| :--- | :--- | :--- | :--- | :--- |
| **Source / Project** | 2–3 GB | ~768 KB | Normal | GDScript, scenes, networking, configs |
...
| **Cache & Builds** | 3–4 GB | ~1.5 MB | Normal | `.godot` cache |
| **Safety Margin** | ~2 GB | N/A | Available | Buffer to prevent hitting storage ceiling |
| **Total Project** | **20 GB Max** | **~2.3 MB** | **Healthy** | Monitored via `/perf-check` |
